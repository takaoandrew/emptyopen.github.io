		...
		<div class="modal-dialog white-content">
			...
			<div class="modal-body">
				...
				<form method="post" action="/users/login" class="form" id="login-form">
					...
					<br /><br />
					Dont have an Account? <a href="/?signup=yes">Create one</a>
				</form>
				<br />
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="container">
				...
				<div class="navbar-header">
					...
					<!-- <a href="#" class="navbar-brand visible-xs"><a href="http://flipkingz.com"><h1 class="logoname">FlipKingz</h1></a></a> -->
					<a href="http://flipkingz.com"><h1 class="logoname">FlipKingz</h1></a>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<?php endif; ?>
						<li class="active"><a href="/users/newlisting" class="btn btn-green"><b class="glyphicon glyphicon-usd darkfont"></b> <b class="darkfont">LIST A WEBSITE OR DOMAIN</b></a>
						</li>
					</ul>
